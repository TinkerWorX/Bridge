...
Bridge.Long.getValue = function (l) {
    ...
    if (l instanceof Bridge.Long || l instanceof Bridge.ULong) {
        return l.value;
    }
...
Bridge.Long.prototype.compareTo = function (l) {
    return this.value.compared(this.T.getValue(l));
};

Bridge.Long.prototype.add = function (l) {
    return new this.T(this.value.add(this.T.getValue(l)));
};

Bridge.Long.prototype.sub = function (l) {
    return new this.T(this.value.sub(this.T.getValue(l)));
};
...
Bridge.Long.prototype.mul = function (l) {
    return new this.T(this.value.mul(this.T.getValue(l)));
};
...
Bridge.Long.prototype.neg = function () {
    return new this.T(this.value.neg());
};

Bridge.Long.prototype.inc = function () {
    return new this.T(this.value.add(1));
};

Bridge.Long.prototype.dec = function () {
    return new this.T(this.value.sub(1));
};
...
Bridge.Long.tryParse = function (str, v) {
    try {
        if (str == null || !/^[+-]?[0-9]+$/.test(str)) {
            v.v = Bridge.$Long.ZERO;
            return false;
        }

        v.v = new Bridge.Long(s);
...
Bridge.Long.MinValue = Bridge.$Long.MIN_VALUE;
Bridge.Long.MaxValue = Bridge.$Long.MAX_VALUE;
...
Bridge.ULong.getValue = function (l) {
    ...
    if (l instanceof Bridge.ULong || l instanceof Bridge.Long) {
        return l.value;
    }
...
Bridge.ULong.tryParse = function (str, v) {
    try {
        if (str == null || !/^[+-]?[0-9]+$/.test(str)) {
            v.v = Bridge.$Long.UZERO;
            return false;
        }

        v.v = new Bridge.ULong(s);
...
Bridge.ULong.MinValue = Bridge.$Long.UZERO;
Bridge.ULong.MaxValue = Bridge.$Long.MAX_UNSIGNED_VALUE;